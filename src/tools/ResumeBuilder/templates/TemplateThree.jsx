...
export default function TemplateThree({ data, order }) {
  ...
  return (
    <div style={{ padding: 22, fontFamily: 'Arial, sans-serif', fontSize: 12, lineHeight: 1.45 }}>
      <div style={{ border: '2px solid #111', borderRadius: 12, padding: 16 }}>
        <div style={{ fontSize: 24, fontWeight: 900, color: '#111' }}>{p.fullName || 'Your Name'}</div>
